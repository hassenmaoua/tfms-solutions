...
import { useClientResponsePagination } from '../../core/ClientResponseProvider';
import { useClientResponse } from '../../core/ClientResponseProvider';
import { useClientRequest } from '../../core/ClientRequestProvider';

const ClientsPagination = () => {
  const { isLoading } = useClientResponse();
  const pagination = useClientResponsePagination();
